...
// Preset Accent Palette Definitions (Light & Dark pairs)
data class AccentPaletteColors(
    ...
    val chipOnBgLight: Color,
    val chipOnTxLight: Color,
    val chipOnBgDark: Color,
    val chipOnTxDark: Color
)

val AccentPalettes = mapOf(
    "gold" to AccentPaletteColors(
        name = "Gold Amber",
        previewColor = Color(0xFFF2B90C),
        lightAccent = Color(0xFF8F6400),
        darkAccent = Color(0xFFF0BC3A),
        lightSecondary = Color(0xFFF2B90C),
        darkSecondary = Color(0xFFF2B90C),
        chipOnBgLight = Color(0x2BF2B90C),
        chipOnTxLight = Color(0xFF7A5B00),
        chipOnBgDark = Color(0x26F0BC3A),
        chipOnTxDark = Color(0xFFF0BC3A)
    ),
    "emerald" to AccentPaletteColors(
        name = "Emerald Green",
        ...
        chipOnBgLight = Color(0x2B10B981),
        chipOnTxLight = Color(0xFF047857),
        chipOnBgDark = Color(0x2634D399),
        chipOnTxDark = Color(0xFF34D399)
    ),
    "blue" to AccentPaletteColors(
        name = "Royal Blue",
        ...
        chipOnBgLight = Color(0x2B3B82F6),
        chipOnTxLight = Color(0xFF1D4ED8),
        chipOnBgDark = Color(0x2660A5FA),
        chipOnTxDark = Color(0xFF60A5FA)
    ),
    "rose" to AccentPaletteColors(
        name = "Cyber Rose",
        ...
        chipOnBgLight = Color(0x2BF43F5E),
        chipOnTxLight = Color(0xFFBE123C),
        chipOnBgDark = Color(0x26FB7185),
        chipOnTxDark = Color(0xFFFB7185)
    ),
    "purple" to AccentPaletteColors(
        name = "Deep Purple",
        previewColor = Color(0xFF8B5CF6),
        lightAccent = Color(0xFF7C3AED),
        darkAccent = Color(0xFFA78BFA),
        lightSecondary = Color(0xFF8B5CF6),
        darkSecondary = Color(0xFFA78BFA),
        chipOnBgLight = Color(0x2B8B5CF6),
        chipOnTxLight = Color(0xFF6D28D9),
        chipOnBgDark = Color(0x26A78BFA),
        chipOnTxDark = Color(0xFFA78BFA)
    ),
    "crimson" to AccentPaletteColors(
        name = "Crimson Red",
        previewColor = Color(0xFFEF4444),
        lightAccent = Color(0xFFDC2626),
        darkAccent = Color(0xFFF87171),
        lightSecondary = Color(0xFFEF4444),
        darkSecondary = Color(0xFFF87171),
        chipOnBgLight = Color(0x2BEF4444),
        chipOnTxLight = Color(0xFFB91C1C),
        chipOnBgDark = Color(0x26F87171),
        chipOnTxDark = Color(0xFFF87171)
    ),
    "cyan" to AccentPaletteColors(
        name = "Cyan Tech",
        previewColor = Color(0xFF06B6D4),
        lightAccent = Color(0xFF0891B2),
        darkAccent = Color(0xFF22D3EE),
        lightSecondary = Color(0xFF06B6D4),
        darkSecondary = Color(0xFF22D3EE),
        chipOnBgLight = Color(0x2B06B6D4),
        chipOnTxLight = Color(0xFF0E7490),
        chipOnBgDark = Color(0x2622D3EE),
        chipOnTxDark = Color(0xFF22D3EE)
    ),
    "sunset" to AccentPaletteColors(
        name = "Sunset Orange",
        previewColor = Color(0xFFF97316),
        lightAccent = Color(0xFFEA580C),
        darkAccent = Color(0xFFFB923C),
        lightSecondary = Color(0xFFF97316),
        darkSecondary = Color(0xFFFB923C),
        chipOnBgLight = Color(0x2BF97316),
        chipOnTxLight = Color(0xFFC2410C),
        chipOnBgDark = Color(0x26FB923C),
        chipOnTxDark = Color(0xFFFB923C)
    )
)
